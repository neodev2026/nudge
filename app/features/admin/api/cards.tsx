...
export async function action({ request }: Route.ActionArgs) {
  ...
  const { adminUpsertCard } = await import("~/features/admin/lib/queries.server");
  ...
  // logic_key is always set to stage_id — all cards in the same stage share the same key
