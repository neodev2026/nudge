...
export const meta = () => [
  { title: "독일어 A1 · 기초 — Nudge" },
  {
    name: "description",
    content:
      "Goethe-Zertifikat A1 기준 625단어. 일상 생존 표현을 125세션으로 완주합니다.",
  },
];

const topics = [
  "인사와 자기소개 (Hallo, Wie heißen Sie?)",
  "숫자와 날짜",
  "가족과 사람",
  "집과 생활용품",
  "음식과 음료",
...
const youtubeLinks = [
  {
    title: "독일어 A1 기초",
    href: "https://www.youtube.com/results?search_query=독일어+A1+기초",
  },
  {
    title: "Nicos Weg A1 (Goethe-Institut 공식 드라마)",
    href: "https://www.youtube.com/results?search_query=Nicos+Weg+A1",
  },
  {
    title: "Easy German — Basic German",
    href: "https://www.youtube.com/results?search_query=easy+german+basic",
  },
];

export default function DeA1Page() {
  return (
      ...
      <div className="mx-auto max-w-3xl px-6 py-10 md:px-10">
        ...
        <div className="mb-10">
          ...
          <p className="max-w-xl leading-relaxed text-gray-600">
            ...
            인사, 숫자, 날짜, 가족, 음식, 교통.
            <br />
            독일에서 길을 찾을 수 있을 정도의 어휘.
          </p>
          <p className="mt-3 text-sm text-gray-400">Goethe-Institut 공인 A1 어휘 기준.</p>
        </div>
        ...
        <section className="mb-10 rounded-xl border border-green-200 bg-green-50 p-6">
          <p className="mb-1 font-black text-gray-900">der Hund → 개</p>
          <p className="mb-3 text-sm text-gray-500">보세요. 들으세요. 따라하세요.</p>
          <p className="text-sm leading-relaxed text-gray-600">
            5단어마다 미니 퀴즈.
            <br />
            125세션을 완주하면 A1 어휘 완성.
          </p>
        </section>
