...
export const meta = () => [
  { title: "독일어 A2 · 초급 — Nudge" },
  {
    name: "description",
    content:
      "Goethe-Zertifikat A2 기준 547단어. 일상 상황에서 간단한 의사소통을 110세션으로 완주합니다.",
  },
];

const topics = [
  "일상 상황 (쇼핑, 레스토랑, 병원)",
  "과거 표현 (gestern, letzte Woche)",
  "감정과 의견 표현",
  "여행과 교통",
  "건강과 신체",
];
...
const youtubeLinks = [
  {
    title: "독일어 A2",
    href: "https://www.youtube.com/results?search_query=독일어+A2",
  },
  {
    title: "Nicos Weg A2",
    href: "https://www.youtube.com/results?search_query=Nicos+Weg+A2",
  },
  {
    title: "Easy German A2",
    href: "https://www.youtube.com/results?search_query=easy+german+A2",
  },
];

export default function DeA2Page() {
  return (
    <div className="min-h-screen bg-[#fdf8f0]">
      <div className="mx-auto max-w-3xl px-6 py-10 md:px-10">
        ...
        <div className="mb-10">
          ...
          <p className="mt-3 text-sm text-gray-400">Goethe-Institut 공인 A2 어휘 기준.</p>
        </div>
