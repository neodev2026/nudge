    ...
    <div className="min-h-screen bg-[#fdf8f0]">
      ...
      <div className="border-b border-gray-200 bg-white px-6 py-16 md:px-10">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="mb-3 text-4xl font-black text-gray-900 md:text-5xl">영어</h1>
      ...
      <div className="mx-auto max-w-3xl px-6 py-12 md:px-10">
        <h2 className="mb-8 text-2xl font-black text-gray-900">영어 학습 로드맵</h2>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={s.step} className="rounded-xl bg-[#fdf8f0] p-5">
                <div className="mb-2 text-xl font-black" style={{ color: "#C8102E" }}>
                  {s.step}
                </div>
      ...
      <div className="border-t border-gray-200 bg-white px-6 py-12 md:px-10">
        <div className="mx-auto max-w-3xl">
          <h2 className="mb-4 text-2xl font-black text-gray-900">왜 Oxford 3000인가요?</h2>
      ...
      <div className="px-6 py-16 md:px-10">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="mb-2 text-2xl font-black text-gray-900">Ready? 시작할 준비가 됐나요?</h2>
          <p className="mb-8 text-gray-500">Oxford 3000으로 영어 어휘를 제대로 완성하세요.</p>
